...
public interface EasyLanguageListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link EasyLanguageParser#loopFor}.
	 * @param ctx the parse tree
	 */
	void enterLoopFor(EasyLanguageParser.LoopForContext ctx);
	/**
	 * Exit a parse tree produced by {@link EasyLanguageParser#loopFor}.
	 * @param ctx the parse tree
	 */
	void exitLoopFor(EasyLanguageParser.LoopForContext ctx);
}